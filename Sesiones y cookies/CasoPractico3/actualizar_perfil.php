...
<body>
    ...
    if (
        ...
        $updatedUser = $bbdd->actualizarUsuario($email, $nombre, $apellidos, $rol);

        echo "<div class='update'>";
        // Si el contenido del objeto no es null, es decir que contiene datos...
        if ($updatedUser != null) {
            echo "<h3>Se han actualizado los datos del usuario <span>" . $updatedUser->getUsuario() . "</span> correctamente.<br>";
            echo "Pulsa en <a href='index.php'>INICIO</a> para volver a la página principal de login.</h3>";
        } else {
