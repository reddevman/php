...
<body>
    <table class="table table-striped">
        ...
        echo "<h4>Los ala-pivots de la tabla NBA son los siguientes:</h4>";

        $resultado = $conMysql->query("SELECT Posicion,Nombre,Nombre_equipo FROM jugadores WHERE Posicion='C-F' ORDER BY Nombre");
