...
<body>
    <fieldset>
        ...
        # Substring necesario para poder eliminar espacios y puntos del nombre del equipo y que se pueda hacer la consulta
        ...
        if ($listado != null) {
            ...
            # Se recorre el array asociativo y se construye la tabla en HTML
